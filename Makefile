...
flags   := -O3 -funroll-loops -I. -I$(snes) -fstrict-aliasing -mcpu=cell -mtune=cell -DBLARGG_NONPORTABLE -ftree-vectorize -maltivec -mbase-toc -fprofile-generate -fprofile-arcs

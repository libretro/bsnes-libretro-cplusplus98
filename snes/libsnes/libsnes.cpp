...
bool snes_load_cartridge_normal(
  ...
  string xmlrom = (rom_xml && *rom_xml) ? string(rom_xml) : SNESCartridge(rom_data, rom_size).xml_memory_map;
...
bool snes_load_cartridge_bsx_slotted(
  ...
  string xmlbsx = (bsx_xml && *bsx_xml) ? string(bsx_xml) : SNESCartridge(bsx_data, bsx_size).xml_memory_map;
...
bool snes_load_cartridge_sufami_turbo(
  ...
  string xmlsta = (sta_xml && *sta_xml) ? string(sta_xml) : SNESCartridge(sta_data, sta_size).xml_memory_map;
  if(stb_data) SNES::memory::stBrom.copy(stb_data, stb_size);
  string xmlstb = (stb_xml && *stb_xml) ? string(stb_xml) : SNESCartridge(stb_data, stb_size).xml_memory_map;
...
bool snes_load_cartridge_super_game_boy(
  ...
  string xmldmg = (dmg_xml && *dmg_xml) ? string(dmg_xml) : SNESCartridge(dmg_data, dmg_size).xml_memory_map;

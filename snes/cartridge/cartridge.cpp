...
void Cartridge::load(Mode::e cartridge_mode, const lstring &xml_list) {
  ...
  supergameboy_version.i = SuperGameBoyVersion::Version1;
  ...
  uint64_t checksum = ~0;                                           foreach(n, memory::cartrom ) checksum = crc32_adjust(checksum, n);
